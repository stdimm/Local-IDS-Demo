...
event icmp_echo_request(c: connection, info: icmp_info, id: count, seq: count, payload: string)
{
  ...
  konexioak[startTime, duration, orig_h, orig_p, resp_h, resp_p]$orig_h = fmt("%s", "193.0.0.1");
  konexioak[startTime, duration, orig_h, orig_p, resp_h, resp_p]$resp_h = fmt("%s", "194.0.0.1");
...
##################### WEIRD ##############################
global wrong_fragment_set = set("bad_ICMP_checksum", 
				"bad_TCP_checksum", 
				"bad_UDP_checksum");
